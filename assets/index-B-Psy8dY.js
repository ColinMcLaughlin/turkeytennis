import{initializeApp as R}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";import{getAuth as q,signInAnonymously as O}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";import{getFirestore as W,setLogLevel as H,doc as w,onSnapshot as j,getDoc as J,setDoc as P}from"https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const m of s)if(m.type==="childList")for(const n of m.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function o(s){const m={};return s.integrity&&(m.integrity=s.integrity),s.referrerPolicy&&(m.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?m.credentials="include":s.crossOrigin==="anonymous"?m.credentials="omit":m.credentials="same-origin",m}function a(s){if(s.ep)return;s.ep=!0;const m=o(s);fetch(s.href,m)}})();const T={apiKey:"AIzaSyAGAKkeso4kFAV6y3S6XILLaEVZ-LB_h_4",authDomain:"turkeytennis-3d372.firebaseapp.com",projectId:"turkeytennis-3d372",storageBucket:"turkeytennis-3d372.firebasestorage.app",messagingSenderId:"964948050175",appId:"1:964948050175:web:d81932731a106cb5980cca",measurementId:"G-2HY1NYSDP2"},Q=T.projectId||"default-app-id",_=null,$=`artifacts/${Q}/public/data/tournament/tournament-state`,x=[{name:"Towson X",players:["Elias","Yoshi"],pool:"B",description:"Welcome Towson X"},{name:"Where is my husband",players:["Brooke","Varidhi"],pool:"B",description:"Brooke is without her husband who is tall. But she should play well."},{name:"Siblings or Married",players:["Laurel","Zim"],pool:"A",description:"Jury is still out. Might be both"},{name:"uWu",players:["Tab","NoNo"],pool:"B",description:"Actively over thinking their match and processing the situation like anime "},{name:"Just Roomates",players:["Moose","Austin"],pool:"A",description:"Just roomates I swear"},{name:"Towson Y",players:["Dan","Sara"],pool:"A",description:"ugh, another towson."},{name:"Team Fun",players:["Colin","Cait"],pool:"A",description:"idk ."},{name:"Team 1 Bed 1 Bath 1 Den",players:["Dan FB","Jess"],pool:"B",description:"Will be good unless kaboom"}],L=[{time:"1:00 PM",court:"1",team1:"Siblings or Married",team2:"Just Roomates",pool:"A",score:"-",team1Idx:2,team2Idx:4},{time:"1:00 PM",court:"2",team1:"Towson Y",team2:"Team Fun",pool:"A",score:"-",team1Idx:5,team2Idx:6},{time:"1:00 PM",court:"3",team1:"Towson X",team2:"Where is my husband",pool:"B",score:"-",team1Idx:0,team2Idx:1},{time:"1:20 PM",court:"1",team1:"Siblings or Married",team2:"Towson Y",pool:"A",score:"-",team1Idx:2,team2Idx:5},{time:"1:20 PM",court:"2",team1:"Just Roomates",team2:"Team Fun",pool:"A",score:"-",team1Idx:4,team2Idx:6},{time:"1:20 PM",court:"3",team1:"uWu",team2:"Team 1 Bed 1 Bath 1 Den",pool:"B",score:"-",team1Idx:3,team2Idx:7},{time:"1:40 PM",court:"1",team1:"Siblings or Married",team2:"Team Fun",pool:"A",score:"-",team1Idx:2,team2Idx:6},{time:"1:40 PM",court:"2",team1:"Just Roomates",team2:"Towson Y",pool:"A",score:"-",team1Idx:4,team2Idx:5},{time:"1:40 PM",court:"3",team1:"Towson X",team2:"uWu",pool:"B",score:"-",team1Idx:0,team2Idx:3},{time:"2:00 PM",court:"1",team1:"Where is my husband",team2:"Team 1 Bed 1 Bath 1 Den",pool:"B",score:"-",team1Idx:1,team2Idx:7},{time:"2:00 PM",court:"2",team1:"Towson X",team2:"Team 1 Bed 1 Bath 1 Den",pool:"B",score:"-",team1Idx:0,team2Idx:7},{time:"2:00 PM",court:"3",team1:"Where is my husband",team2:"uWu",pool:"B",score:"-",team1Idx:1,team2Idx:3}],M={quarterfinals:[{id:"qf1",team1:"Pool A 1st",team2:"Pool B 1st",score:"-",winner:null},{id:"qf2",team1:"Pool A 4th",team2:"Pool B 4th",score:"-",winner:null},{id:"qf3",team1:"Pool A 2nd",team2:"Pool B 2nd",score:"-",winner:null},{id:"qf4",team1:"Pool A 3rd",team2:"Pool B 3rd",score:"-",winner:null}],semifinals:[{id:"sf1",team1:"Winner QF1",team2:"Winner QF2",score:"-",winner:null},{id:"sf2",team1:"Winner QF3",team2:"Winner QF4",score:"-",winner:null}],finals:[{id:"f1",team1:"Winner SF1",team2:"Winner SF2",score:"-",winner:null}],consolationSemis:[{id:"csf1",team1:"Loser QF1",team2:"Loser QF2",score:"-",winner:null},{id:"csf2",team1:"Loser QF3",team2:"Loser QF4",score:"-",winner:null}],consolationFinals:[{id:"cf1",team1:"Winner CSF1",team2:"Winner CSF2",score:"-",winner:null}]},E=["Team Julia and Theo","Team Joel and Luke","Undisclosed","Team Adam and Vinny","Team PeeCeeTee","Team Johnny and grant","Team Homestead","Team Jack","Team Ash"],z="turkey2024";let i={},B=!1,y;const U=`
...
`).join(""),X=()=>E.map(e=>`<li>${e}</li>`).join(""),G=()=>i.teams.map((e,t)=>`
...
`).join(""),C=()=>{const e={};return i.teams.forEach((t,o)=>{e[o]={wins:0,losses:0}}),i.matchSchedule.forEach(t=>{if(t.score!=="-"){const o=t.score.split("-").map(a=>parseInt(a.trim()));o.length===2&&o[0]!==o[1]&&(o[0]>o[1]?(e[t.team1Idx].wins++,e[t.team2Idx].losses++):o[1]>o[0]&&(e[t.team2Idx].wins++,e[t.team1Idx].losses++))}}),e},K=()=>i.matchSchedule?`
  ...
  `},I=async e=>{if(!y)return console.error("Firestore not initialized.");try{const t=w(y,$);await P(t,e,{merge:!0}),console.log("Tournament state saved successfully.")}catch(t){console.error("Error saving state:",t);const o=document.getElementById("result");o&&(o.textContent="Error: Could not save score to database.",o.className="result error")}},ee=async()=>{if(!y)return;const e=w(y,$);(await J(e)).exists()||(console.log("No existing tournament data found. Initializing new tournament."),await P(e,{teams:x,matchSchedule:L,bracketMatches:M,bracketPlayActive:!1,alternates:E}))},F=()=>{const e=document.getElementById("app");if(!(!e||!i.teams))try{e.innerHTML=`
      <div>
    ...
    `,ae(),S("home"),N("pool-play"),i.bracketPlayActive&&te(),document.getElementById("loading").style.display="none",document.getElementById("app").style.display="block"}catch(t){console.error("Critical Rendering Error:",t),document.getElementById("loading").style.display="none",document.getElementById("app").style.display="block",e.innerHTML='<div style="color: red; padding: 2rem;">CRITICAL RENDERING ERROR: Failed to build the page content. Check the console (F12) for JavaScript errors.</div>'}},S=e=>{document.querySelectorAll(".tab-button").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".tab-pane").forEach(a=>a.classList.remove("active"));const t=document.querySelector(`[data-tab="${e}"]`),o=document.getElementById(e);t&&o&&(t.classList.add("active"),o.classList.add("active"))},N=e=>{document.querySelectorAll(".subtab-button").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".subtab-pane").forEach(a=>a.classList.remove("active"));const t=document.querySelector(`[data-subtab="${e}"]`),o=document.getElementById(e);t&&o&&(t.classList.add("active"),o.classList.add("active"))},te=()=>{const e=document.getElementById("bracket-match-select");if(!e)return;e.innerHTML='<option value="">Choose a bracket match...</option>';const t=i.bracketMatches;[{round:"qf",matches:t.quarterfinals,prefix:"Quarterfinal"},{round:"sf",matches:t.semifinals,prefix:"Semifinal"},{round:"f",matches:t.finals,prefix:"Finals"},{round:"csf",matches:t.consolationSemis,prefix:"Consolation Semifinal"},{round:"cf",matches:t.consolationFinals,prefix:"Consolation Finals"}].forEach(({round:a,matches:s,prefix:m})=>{s.forEach((n,r)=>{const d=n.team1.includes("Pool")||n.team1.includes("Winner")||n.team1.includes("Loser")||n.team1.includes("TBD");if(n.score==="-"&&!d){let l=`${m} ${a!=="f"&&a!=="cf"?r+1:""}`.trim();e.innerHTML+=`<option value="${a}-${r}">${l}: ${n.team1} vs ${n.team2}</option>`}})})},ae=()=>{const e=document.getElementById("app");if(!e)return;e.onclick=n=>{n.target.classList.contains("tab-button")&&n.target.getAttribute("data-tab")?S(n.target.getAttribute("data-tab")):n.target.classList.contains("subtab-button")&&n.target.getAttribute("data-subtab")?N(n.target.getAttribute("data-subtab")):n.target.classList.contains("team-card")&&n.target.getAttribute("data-team-id")&&S("teams")};const t=document.getElementById("passwordBtn");t&&(t.onclick=()=>{const n=document.getElementById("password").value,r=document.getElementById("password-result");n===z?(B=!0,F(),r.textContent="Unlocked!",r.className="result success"):(r.textContent="Incorrect password",r.className="result error")});const o=document.getElementById("submitBtn");o&&(o.onclick=async()=>{if(!B)return;const n=parseInt(document.getElementById("match-select").value),r=parseInt(document.getElementById("score1").value),d=parseInt(document.getElementById("score2").value),l=document.getElementById("result");if(isNaN(n)||n<0||isNaN(r)||isNaN(d)){l.textContent="Please select a match and enter valid scores",l.className="result error";return}if(i.matchSchedule[n].score!=="-"){l.textContent="Score already submitted for this match.",l.className="result error";return}const c=i.matchSchedule[n];let b,u=[...i.matchSchedule];if(r===d){u[n].score=`${r} - ${d}`,await I({matchSchedule:u}),l.textContent=`${c.team1} ${r} - ${d} ${c.team2} (Tied)`,l.className="result tie";return}b=r>d?c.team1:c.team2,u[n].score=`${r} - ${d}`,await I({matchSchedule:u}),l.textContent=`${c.team1} ${r} - ${d} ${c.team2} | Winner: ${b}`,l.className="result success",document.getElementById("match-select").value="",document.getElementById("score1").value="",document.getElementById("score2").value=""});const a=document.getElementById("concludeBtn");a&&(a.onclick=async()=>{const n=C(),r=i.teams.filter(c=>c.pool==="A").map(c=>{const b=i.teams.indexOf(c);return{...c,teamIdx:b,record:n[b]}}).sort((c,b)=>b.record.wins-c.record.wins),d=i.teams.filter(c=>c.pool==="B").map(c=>{const b=i.teams.indexOf(c);return{...c,teamIdx:b,record:n[b]}}).sort((c,b)=>b.record.wins-c.record.wins);let l=JSON.parse(JSON.stringify(i.bracketMatches));l.quarterfinals[0].team1=r[0].name,l.quarterfinals[0].team2=d[0].name,l.quarterfinals[1].team1=d[3].name,l.quarterfinals[1].team2=r[3].name,l.quarterfinals[2].team1=r[1].name,l.quarterfinals[2].team2=d[1].name,l.quarterfinals[3].team1=d[2].name,l.quarterfinals[3].team2=r[2].name,await I({bracketMatches:l,bracketPlayActive:!0}),document.getElementById("result").textContent="Pool play concluded! Bracket play has begun.",document.getElementById("result").className="result success"});const s=document.getElementById("submitBracketBtn");s&&(s.onclick=async()=>{const n=document.getElementById("bracket-match-select").value,r=parseInt(document.getElementById("bracket-score1").value),d=parseInt(document.getElementById("bracket-score2").value),l=document.getElementById("result");if(!n||isNaN(r)||isNaN(d)||r===d){l.textContent="Please select a match and enter valid (non-tied) scores",l.className="result error";return}const[c,b]=n.split("-"),u=parseInt(b);let p=JSON.parse(JSON.stringify(i.bracketMatches)),v,k,A;const g=(h,f,D)=>{v=h[f],k=r>d?v.team1:v.team2,A=r>d?v.team2:v.team1,v.score=`${r} - ${d}`,v.winner=k,D(k,A)};c==="qf"?g(p.quarterfinals,u,(h,f)=>{u===0?(p.semifinals[0].team1=h,p.consolationSemis[0].team1=f):u===1?(p.semifinals[0].team2=h,p.consolationSemis[0].team2=f):u===2?(p.semifinals[1].team1=h,p.consolationSemis[1].team1=f):u===3&&(p.semifinals[1].team2=h,p.consolationSemis[1].team2=f)}):c==="sf"?g(p.semifinals,u,h=>{u===0?p.finals[0].team1=h:u===1&&(p.finals[0].team2=h)}):c==="f"?g(p.finals,u,()=>{}):c==="csf"?g(p.consolationSemis,u,h=>{u===0?p.consolationFinals[0].team1=h:u===1&&(p.consolationFinals[0].team2=h)}):c==="cf"&&g(p.consolationFinals,u,()=>{}),await I({bracketMatches:p}),l.textContent=`Score submitted: ${v.team1} ${r} - ${d} ${v.team2} | Winner: ${k}`,l.className="result success",document.getElementById("bracket-match-select").value="",document.getElementById("bracket-score1").value="",document.getElementById("bracket-score2").value=""});const m=document.getElementById("resetBtn");m&&(m.onclick=async()=>{await I({teams:x,matchSchedule:L,bracketMatches:M,bracketPlayActive:!1,alternates:E}),document.getElementById("result").textContent="Tournament has been reset!",document.getElementById("result").className="result error"})},se=async()=>{const e=document.getElementById("loading"),t=document.getElementById("app");if(Object.keys(T).length===0){e&&(e.innerHTML='<div style="color: red; padding: 2rem; font-weight: bold;">FATAL ERROR: Firebase Configuration is Missing. Cannot connect to database.</div>');return}try{const o=R(T);y=W(o),H("error");const a=q(o);_||await O(a),console.log("Firebase authenticated successfully."),await ee();const s=w(y,$);j(s,m=>{m.exists()?(i=m.data(),F()):console.warn("Tournament state document does not exist. A new one should be initialized shortly.")})}catch(o){console.error("Firebase Initialization Failed:",o),e&&(e.innerHTML=`
