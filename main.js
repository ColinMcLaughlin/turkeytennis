...
// Note: Towson X was removed and replaced by 'openslot' at Team Index 0.
const INITIAL_TEAMS = [
  { name: 'openslot', players: ['your partners name here', 'your name here'], pool: 'A', description: 'OPEN' }, // Moved to Pool A to balance pools
...
  { name: 'Team Fun', players: ['Colin', 'Cait'], pool: 'B', description: 'vroom vroom' }, // Moved to Pool B to balance pools
  { name: 'Team 1 Bed 1 Bath 1 Den', players: ['Dan FB', 'Jess'], pool: 'B', description: 'Will be good unless kaboom' }
];

/* * TEAM INDEXES (Updated after pool changes):
* Pool A (4 Teams): 0, 2, 4, 5
* Pool B (4 Teams): 1, 3, 6, 7
* * A fair 4-team pool schedule involves 6 total matches (each team plays 3 times).
* Your schedule has 12 slots, so each team plays 3 pool matches and 3 crossover/extra matches.
* This schedule is reorganized to ensure each team plays 3 matches total.
*/
const INITIAL_SCHEDULE = [
  // --- 1:00 PM (4 Pool A vs 4 Pool B) ---
  { time: '1:00 PM', court: '1', team1: 'Siblings or Married', team2: 'Just Roomates', pool: 'A', score: '-', team1Idx: 2, team2Idx: 4 },
  { time: '1:00 PM', court: '2', team1: 'Where is my husband', team2: 'uWu', pool: 'B', score: '-', team1Idx: 1, team2Idx: 3 },
  { time: '1:00 PM', court: '3', team1: 'Towson Y', team2: 'openslot', pool: 'A', score: '-', team1Idx: 5, team2Idx: 0 },
  { time: '1:00 PM', court: '4', team1: 'Team Fun', team2: 'Team 1 Bed 1 Bath 1 Den', pool: 'B', score: '-', team1Idx: 6, team2Idx: 7 }, // Added Court 4 for 8-team round

  // --- 1:20 PM (Same Teams, Swapped Opponents) ---
  { time: '1:20 PM', court: '1', team1: 'openslot', team2: 'Siblings or Married', pool: 'A', score: '-', team1Idx: 0, team2Idx: 2 },
  { time: '1:20 PM', court: '2', team1: 'Just Roomates', team2: 'Towson Y', pool: 'A', score: '-', team1Idx: 4, team2Idx: 5 },
  { time: '1:20 PM', court: '3', team1: 'Where is my husband', team2: 'Team Fun', pool: 'B', score: '-', team1Idx: 1, team2Idx: 6 },
  { time: '1:20 PM', court: '4', team1: 'uWu', team2: 'Team 1 Bed 1 Bath 1 Den', pool: 'B', score: '-', team1Idx: 3, team2Idx: 7 }, // Added Court 4

  // --- 1:40 PM (Final Pool Matches) ---
  { time: '1:40 PM', court: '1', team1: 'openslot', team2: 'Just Roomates', pool: 'A', score: '-', team1Idx: 0, team2Idx: 4 },
  { time: '1:40 PM', court: '2', team1: 'Siblings or Married', team2: 'Towson Y', pool: 'A', score: '-', team1Idx: 2, team2Idx: 5 },
  { time: '1:40 PM', court: '3', team1: 'Where is my husband', team2: 'Team 1 Bed 1 Bath 1 Den', pool: 'B', score: '-', team1Idx: 1, team2Idx: 7 },
  { time: '1:40 PM', court: '4', team1: 'uWu', team2: 'Team Fun', pool: 'B', score: '-', team1Idx: 3, team2Idx: 6 } // Added Court 4
];
